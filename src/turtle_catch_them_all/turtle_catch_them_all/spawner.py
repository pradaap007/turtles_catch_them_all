...
from my_turtle_interface.msg import TurtleProjectArray
from my_turtle_interface.srv import CatchTurtle
...
class TurtleSpawner(Node):
    def __init__(self):
        ...
        self.alive_turtles_ = []
        self.alive_turtles_publisher_ = self.create_publisher(TurtleProjectArray,
                                                              "alive_turtles", 10)
